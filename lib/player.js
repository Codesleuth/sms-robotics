...
Player.prototype.resetTimeout = function () {
  ...
  this._expectedTimeout = moment().add(this.timeoutDelay, 'milliseconds');
...
Player.prototype.getExpectedTimeout = function () {
  return this._expectedTimeout;
};
